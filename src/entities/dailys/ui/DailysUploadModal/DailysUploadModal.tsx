...
import { useCreatePrizeValuesMutation } from '../../model/api/daily.api';
import { Modal } from '@/shared/ui/Modal/Modal';
import { Input } from '@/shared/ui/Input/Input';

interface DailysUploadModalProps {
  open: boolean;
  onClose: () => void;
  prizeId: number;
}

export const DailysUploadModal: React.FC<DailysUploadModalProps> = ({
  open,
  onClose,
  prizeId,
}) => {
