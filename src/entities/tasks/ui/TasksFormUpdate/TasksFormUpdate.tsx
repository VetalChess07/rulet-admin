...
import cls from './TasksFormUpdate.module.scss';
...
interface TasksFormUpdateProps {
...
export const TasksFormUpdate: React.FC<TasksFormUpdateProps> = ({
  onSubmit,
  formData,
  setFormData,
  setLogoFile,
